...
- **Multi-modal AI**: Process both text and images with advanced AI models
- **Flexible Model Selection**: Choose from various AI models or use your own custom models
- **HyDE Search Enhancement**: Improved search results using Hypothetical Document Embeddings
- **Document Processing**: Extract and analyze information from documents
- **Analytics**: Track usage and performance metrics
- **User Management**: Personalized settings and history
...
### Local Models
- Hugging Face models (Mistral, Llama, etc.)
- Custom models via URL or local path
...
1. Selecting "Use custom model" in the model selector
2. Providing a model URL (Hugging Face, GitHub) or local path
3. Configuring model parameters (temperature, max tokens)

For more details, see the [Model Management Documentation](docs/MODEL_MANAGEMENT.md).

## Usage

1. Log in to the application
2. Select your preferred AI model in settings
3. Start chatting or upload images for analysis
4. Use the search functionality with HyDE for better results
5. Upload documents for processing and analysis

## Development

### Project Structure

- `models_app/`: AI model integration and management
- `users_app/`: User management and settings
- `chat_app/`: Chat functionality
- `search_app/`: Search functionality with HyDE
- `analytics_app/`: Usage tracking and analytics
